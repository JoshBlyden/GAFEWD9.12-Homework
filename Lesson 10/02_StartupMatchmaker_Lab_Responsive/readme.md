...
###Requirements
* DONE Add the viewport meta tag <meta name="viewport" content="width=device-width, initial-scale=1">
* DONE The maximum size of the content is 960px wide
* DONE The member companies should be displayed 2-across at desktop sizes and 1-across on tablet sizes and smaller (768px)
* DONE The member company logo should center and be above everything except the header at sizes below (and including)768px.
* DONE The width of the logo for smaller screens should never exceed 35%
